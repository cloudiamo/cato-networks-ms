...
COPY --chown=1000:1000 . /opt/fmc_repository/cato-networks-ms
RUN install_repo_deps.sh /opt/fmc_repository/cato-networks-ms/

# Cleanup repository {{{
RUN rm -rf /opt/fmc_repository/cato-networks-ms/{.git,docker,Dockerfile}
# }}}
# Build tarball {{{
